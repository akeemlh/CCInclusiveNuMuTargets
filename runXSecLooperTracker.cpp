...
class CCInclTracker : public XSec
{
public:
  CCInclTracker(const char* name) : 
  XSec(name){};
  ...
  virtual bool passesCuts(PlotUtils::ChainWrapper& chw, int entry)
  {
    ...
    //if (!targetInfo.InNukeRegion(true_muon_vtx_x, true_muon_vtx_y, true_muon_vtx_z)) return false;
...
/* 
  ...
  */
  ...
  CCInclTracker* ds_dpT = new CCInclTracker("pTmu");
  ...
  CCInclTracker* ds_dpZ = new CCInclTracker("pZmu");
  ...
  CCInclTracker* ds_dpEMu = new CCInclTracker("Emu");
  ...
  CCInclTracker* ds_dpERecoil = new CCInclTracker("Erecoil");
  ...
  CCInclTracker* ds_dpMeasX = new CCInclTracker("measX");
  ...
  CCInclTracker* ds_dpX = new CCInclTracker("BjorkenX");
  ...
  CCInclTracker* ds_dpTdpZ = new CCInclTracker("pTpZ");
  ...
  std::string geniefilename =  "GENIEXSECEXTRACT_Tracker.root";
